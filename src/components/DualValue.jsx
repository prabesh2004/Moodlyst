      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="bg-linear-to-br from-purple-50 to-pink-50 rounded-3xl p-10 border-2 border-purple-100"
          >
          ...
          <motion.div
            ...
            className="bg-linear-to-br from-orange-50 to-rose-50 rounded-3xl p-10 border-2 border-rose-100"
          >
            <div className="text-5xl mb-6">🌍</div>
            <h3 className="font-poppins text-2xl font-bold text-gray-900 mb-4">
